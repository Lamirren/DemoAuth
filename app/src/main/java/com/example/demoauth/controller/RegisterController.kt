...
class RegisterController(private val view: RegisterActivity, private val userModel: UserModel) {
    fun register(email: String, password: String, confirmPassword: String) {
        val validationResult = validateInput(email, password, confirmPassword)
    ...
    private fun validateInput(email: String, password: String, confirmPassword: String): ValidationResult {
        if (email.isEmpty()) {
